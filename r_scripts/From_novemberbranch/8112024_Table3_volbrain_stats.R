#this script is for creating the table of the volbrain deeplesion output in the growthcurves paper
library(dplyr)
library(writexl)
library(tidyr)
...
# Count the number of analyzed observations
num_analyzed_scans <- nrow(table4_volbrain_df)
cat("Number of analyzed scans/observations:", num_analyzed_scans, "\n")
